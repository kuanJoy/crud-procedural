...
INSERT INTO `users` (`id_user`, `name`, `surname`, `email`, `password`, `photo`, `id_group`, `id_role`) VALUES
	...
	(4, 'Куанышбек', 'Мыкыев', 'kuanyshmykyev@gmail.com', '$2y$10$o/egMQR6/aQoawvcFG.o/u5.Nt2Oa8P3SPqzCP.TfB0ikKyIAja.6', './assets/images/upload/kuanyshmykyev@gmail.com65c0b8db93a770.76230556.png', 2, 2),
